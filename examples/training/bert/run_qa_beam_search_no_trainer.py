...
def parse_args():
    ...
    parser.add_argument("--fp8_training", action="store_true", help="Enable FP8 training")

    parser.add_argument(
        "--fp8_algo",
        type=str,
        default="direct",
        help="Training algprithms : direct, hybrid modes.",
    )
...
def main():
    ...
    accelerator = Accelerator(mixed_precision="fp16", gradient_accumulation_steps=args.gradient_accumulation_steps, **accelerator_log_kwargs)
    ...
    if args.fp8_training:
        ...
        model, emulator = mpt_emu.initialize(model, optimizer, training_algo=args.fp8_algo, pruning_algo="None",
